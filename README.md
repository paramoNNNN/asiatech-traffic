...
```
wget https://github.com/mozilla/geckodriver/releases/download/v0.19.1/geckodriver-v0.19.1-linux64.tar.gz && tar -xf geckodriver-v0.19.1-linux64.tar.gz && rm geckodriver-v0.19.1-linux64.tar.gz && sudo mv geckodriver /usr/local/bin/
```
